...
export const FBFM13: { [key: string]: FuelModel13 } = {
	...
	FBFM7: {
		...
		name: 'Southern rough',
		description:
			'Fires burn through the surface and shrub strata with equal ease and can occur at higher dead fuel moisture contents because of the flammability of liveHerbaceous foliage and other liveHerbaceous material. Stands of shrubs are generally between 2 and 6 feet (0.6 and 1.8 m) high. Palmetto-gallberry understory-pine overstory sites are typical and low pocosins may be represented. Black spruce-shrub combinations in Alaska may also be represented. This fuel model correlates with 1978 NFDRS model D and can be a second choice for model Q. Photographs 19, 20, and 21 depict field situations for this model.',
		fuelLoading: {
			oneHour: 1.13,
			tenHour: 1.87,
			hundredHour: 1.5,
